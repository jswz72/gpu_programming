/**
  Jacob Sword
  Parallelized multiplication of two randomized matrices given dimensions of each using OMP
**/
#include <stdio.h>
#include <stdlib.h>
#include <iostream>
...
void mat_mult_omp(int *mat_a, int *mat_b, int *result, int a_rows, int a_cols, int b_cols) {
#pragma omp parallel
    {
...
int main (int argc, char **argv) {
    ...
    mat_mult_omp(a, b, c, a_rows, a_cols, b_cols);
